...
public class RepPessoas implements Serializable, IRepositorioPessoas {
	...
	public void adicionarPessoa(Pessoa pessoa) { // cadastra um funcionario no
													// arrayList
		this.pessoas.add(pessoa);
		RepPessoas.salvarArquivo();
	}

	public void adicionarPessoa(int i, Pessoa pessoa) { // cadastra um
														// funcionario no
														// arrayList na posição
														// especifica
		this.pessoas.add(i, pessoa);
		RepPessoas.salvarArquivo();
	}

	public String getString(int i) { // retorna um funcionario na posição i no
										// arrayList
	...
	public ArrayList<Pessoa> getPessoas(String conteudo) { // caso o parametro
															// seja null,
															// retorna Todo o
															// Array. Caso
															// contrário,
	...
	public int buscarIndiceNome(String nome) throws FuncionarioNaoEncontradoException { // retorna
																						// o
																						// índice
																						// do
																						// Funcionario
	...
	public int buscarIndiceCpf(String cpf) throws FuncionarioNaoEncontradoException { // retorna
																						// o
																						// índice
																						// do
																						// Funcionario
	...
	public Pessoa buscarPessoaNome(String nome) throws FuncionarioNaoEncontradoException { // retorna
																							// o
																							// Objeto
																							// Funcionario
																							// a
	...
	public Pessoa buscarPessoaCpf(String cpf) throws FuncionarioNaoEncontradoException { // retorna
																							// o
																							// Objeto
																							// Funcionario
																							// a
