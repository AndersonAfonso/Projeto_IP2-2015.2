...
public class RepRegPonto implements Serializable, IRepositorioPontos {
	...
	public ArrayList<RegPonto> getPontosDoFuncionario(String cpf) throws FuncionarioNaoEncontradoException { // procurar
																												// pontos
																												// desse
																												// CPF
	...
	public ArrayList<RegPonto> getPontosDoFuncionario(String cpf, int mes, int ano)
			throws FuncionarioNaoEncontradoException { // procurar pontos desse
														// CPF nesse mes e ano
		ArrayList<RegPonto> pontosDoFuncionario = new ArrayList<RegPonto>();
		Funcionario funcionario = (Funcionario) EpontoFachada.getInstance().getPessoaCpf(cpf);
		for (int i = 0; i < this.repositorio.size(); i++) {
			if (repositorio.get(i).getFuncionario().equals(funcionario)
					&& repositorio.get(i).getAgora().getMonthValue() == mes
					&& repositorio.get(i).getAgora().getYear() == ano)
				pontosDoFuncionario.add(repositorio.get(i));
		}
	...
	public ArrayList<RegPonto> getPontosDoFuncionario(String cpf, int dia, int mes, int ano)
		...
		for (int i = 0; i < this.repositorio.size(); i++) {
			if (repositorio.get(i).getFuncionario().equals(funcionario)
					&& repositorio.get(i).getAgora().getYear() == ano
					&& repositorio.get(i).getAgora().getMonthValue() == mes
					&& repositorio.get(i).getAgora().getDayOfMonth() == dia)
				pontosDoFuncionario.add(repositorio.get(i));
		}
	...
	public int totalChegadaCorreta(String cpf) throws FuncionarioNaoEncontradoException { // retorna
																							// o
																							// total
																							// de
																							// pontos
	...
	public int totalSaidaCorreta(String cpf) throws FuncionarioNaoEncontradoException { // retorna
																						// o
																						// total
																						// de
																						// pontos
	...
	public int totalIntervalo_InCorreta(String cpf) throws FuncionarioNaoEncontradoException { // retorna
																								// o
																								// total
																								// de
																								// pontos
	...
	public int totalIntervalo_OutCorreta(String cpf) throws FuncionarioNaoEncontradoException { // retorna
																								// o
																								// total
																								// de
																								// pontos
	...
	public boolean isDiaCorreto(String cpf, int dia, int mes, int ano) throws FuncionarioNaoEncontradoException {
		...
		retorno = pontos.get(0).isChegadaCorreta() && pontos.get(1).isIntervalo_OutCorreta()
				&& pontos.get(2).isIntervalo_InCorreta() && pontos.get(3).isSaidaCorreta();
		return retorno;
	}
