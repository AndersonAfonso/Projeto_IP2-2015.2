...
public class FrameAdmin1 extends JFrame implements ActionListener, MouseListener, WindowListener, FocusListener {
	...
	// cujo nome contém a String passado como parâmetro.
		...
		if (e.getSource().equals(btnPesquisar)) {
			...
			if (EpontoFachada.getInstance().getSizeEmpresas() < 1)
				JOptionPane.showMessageDialog(null,
						"É necessário cadastrar uma empresa antes de cadastrar um funcionário.");
			else
			...
			if (EpontoFachada.getInstance().getSizeEmpresas() < 1)
				JOptionPane.showMessageDialog(null,
						"É necessário cadastrar uma empresa antes de cadastrar um Administrador.");
			else
