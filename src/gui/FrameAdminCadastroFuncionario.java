	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource().equals(btnLimpar)) {
			...
			try {
				...
				horaChegada = LocalTime.of(Integer.parseInt(txtHoraChegada.getText()),
						Integer.parseInt(txtMinutosChegada.getText()));
				horaSaida = LocalTime.of(Integer.parseInt(txtHoraSaida.getText()),
						Integer.parseInt(txtMinutosSaida.getText()));
				horaChegadaIntervalo = LocalTime.of(Integer.parseInt(txtHoraChegadaIntervalo.getText()),
						Integer.parseInt(txtMinutosChegadaIntervalo.getText()));
				horaSaidaIntervalo = LocalTime.of(Integer.parseInt(txtHoraSaidaIntervalo.getText()),
						Integer.parseInt(txtMinutosSaidaIntervalo.getText()));
				funcionario = new Funcionario(nome, cpf, email, senha, telefone, empresa, cargo, "Seg. à Sex",
						horaChegada, horaSaida, horaChegadaIntervalo, horaSaidaIntervalo);
				funcionario.setFotoPadrao(new ImageIcon(wCam.getImage().getScaledInstance(160, 120, 0)));
