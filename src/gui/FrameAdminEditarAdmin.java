...
public class FrameAdminEditarAdmin extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FrameAdminEditarAdmin frame = new FrameAdminEditarAdmin(
							new Admin("ikaro", "123456t", "iajfaijf", senha));
	...
	public FrameAdminEditarAdmin(Admin admin) {
		...
		scrllPnLista
				.setToolTipText("N\u00E3o \u00E9 necess\u00E1rio selecionar uma empresa caso n\u00E3o queria alterar.");
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource().equals(btnLimpar)) {
			...
			if (jListaEmpresas.getSelectedIndices().length == 0) {
				...
				try {
					EpontoFachada.getInstance().editarPessoa(EpontoFachada.getInstance().getIndiceCpf(admin.getCpf()),
							(adminNew));
