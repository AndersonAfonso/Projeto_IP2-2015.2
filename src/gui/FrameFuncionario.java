...
public class FrameFuncionario extends JFrame implements ActionListener, WindowListener {
			...
			public void run() {
				try {
					FrameFuncionario frame = new FrameFuncionario(
							(Funcionario) RepPessoas.getInstance().buscarPessoaNome("Ikaro Alef"));
	...
	public FrameFuncionario(Funcionario funcionario) {
		...
		wCam.setViewSize(WebcamResolution.QQVGA.getSize());
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource().equals(btnBaterPonto)) {
			...
			try {
				ponto.registrarPonto((Funcionario) EpontoFachada.getInstance().getPessoaCpf(funcionario.getCpf()),
						new ImageIcon(wCam.getImage()));
