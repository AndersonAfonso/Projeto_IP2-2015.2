...
public class EpontoFachada {
	...
	public int getIndiceNome(String nome) throws FuncionarioNaoEncontradoException {
		return pessoas.buscarIndiceNome(nome);
	}

	public int getIndiceCpf(String cpf) throws FuncionarioNaoEncontradoException {
		return pessoas.buscarIndiceCpf(cpf);
	}

	public Pessoa getPessoaNome(String nome) throws FuncionarioNaoEncontradoException {
		return pessoas.buscarPessoaNome(nome);
	}

	public Pessoa getPessoaCpf(String cpf) throws FuncionarioNaoEncontradoException {
	...
	public ArrayList<RegPonto> getPontosDoFuncionario(String cpf) throws FuncionarioNaoEncontradoException {
	...
	public int getTotalDiasCorretos(String cpf, int mes, int ano) throws FuncionarioNaoEncontradoException {
		return pontos.getTotalDiasCorretos(cpf, mes, ano);
	}

	public int getTotalDiasAtrasado(String cpf, int mes, int ano) throws FuncionarioNaoEncontradoException {
		return pontos.getTotalDiasAtrasado(cpf, mes, ano);
	}

	public int totalChegadaCorreta(String cpf) throws FuncionarioNaoEncontradoException {
		return pontos.totalChegadaCorreta(cpf);
	}

	public int totalSaidaCorreta(String cpf) throws FuncionarioNaoEncontradoException {
		return pontos.totalSaidaCorreta(cpf);
	}

	public int totalIntervalo_InCorreta(String cpf) throws FuncionarioNaoEncontradoException {
		return pontos.totalIntervalo_InCorreta(cpf);
	}

	public int totalIntervalo_OutCorreta(String cpf) throws FuncionarioNaoEncontradoException {
