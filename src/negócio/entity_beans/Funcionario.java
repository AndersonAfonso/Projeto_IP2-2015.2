...
public class Funcionario extends Pessoa implements Serializable {
	...
	private LocalTime chegada, saida, intervalo_in, intervalo_out; // chegada,
																	// saida,
																	// voltou do
																	// intervalo,
																	// saiu para
	...
	public Funcionario(String nome, String cpf, String email, char[] senha, String telefone, Empresa empresa,
			String cargo, String escala, LocalTime chegada, LocalTime saida, LocalTime intervalo_in,
			LocalTime intervalo_out) throws NomeInvalidoException {
	...
	public String toString() {
		return ("Nome: " + getNome() + " \nCPF: " + getCpf() + "\nE-mail:" + getEmail() + "\nHora de Chegada: "
				+ String.valueOf(getChegada())) + "\nCargo: " + getCargo() + "\nEmpresa: " + getEmpresa();
	}

	public boolean equals(Funcionario funcionario) {
		if (funcionario != null) {
			return this.nome.equalsIgnoreCase(funcionario.getNome()) && this.cpf.equalsIgnoreCase(funcionario.getCpf());
		}
		return false;
	}
